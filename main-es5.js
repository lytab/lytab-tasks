...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsTasksTasksComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_tasks_tasks_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _components_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_4__["NavbarComponent"], _components_tasks_tasks_component__WEBPACK_IMPORTED_MODULE_5__["TasksComponent"]],
  ...
  /***/
  function srcAppComponentsTasksTasksComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppComponentsTasksTasksComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(TasksComponent, [{
        ...
        value: function getTasks() {
          ...
          this.taskService.getTasks().subscribe(function (data) {
            _this.tasksFilter = _this.tasks = data;
          });
        }
      }, {
        key: "deleteTask",
        value: function deleteTask(task) {
          ...
          this.taskService.delete(task.id).subscribe(function () {
            var index = _this2.tasksFilter.indexOf(task);

            _this2.tasksFilter.splice(index, 1);
          });
        }
      }, {
        key: "persistTask",
        value: function persistTask() {
          var _this3 = this;

          this.taskService.persist(this.myTask).subscribe(function (data) {
            _this3.tasksFilter.push(data); //this.tasks=[this.myTask,...this.tasks];
        ...
        key: "toggleCompleted",
        value: function toggleCompleted(task) {
          this.taskService.completed(task.id, task.completed).subscribe(function () {
        ...
        value: function updateTask() {
          ...
          this.taskService.update(this.myTask).subscribe(function () {
            _this4.resetTask();
          });
        }
      }, {
        key: "seachTasks",
        value: function seachTasks() {
          var _this5 = this;

          this.tasksFilter = this.tasks.filter(function (task) {
            return task.label.toLowerCase().includes(_this5.search);
          });
        }
      }]);
    ...
    TasksComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/tasks/tasks.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./tasks.component.css */
      "./src/app/components/tasks/tasks.component.css")).default]
    })], TasksComponent);
    /***/
  },
  ...
  function srcAppServicesTaskServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function TaskService(http) {
        ...
        this.http = http;
        this.url = "https://my-json-server.typicode.com/lytab/JsonDB/tasks";
      }
      ...
      _createClass(TaskService, [{
        ...
        key: "persist",
        value: function persist(task) {
          return this.http.post(this.url, task, httpOptions);
        }
      }, {
        key: "completed",
        value: function completed(id, _completed) {
          return this.http.patch("".concat(this.url, "/").concat(id), {
        ...
        value: function update(task) {
          return this.http.put("".concat(this.url, "/").concat(task.id), {
            label: task.label,
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\Projet2020\Angular\Angular8\Mohammed Idbrahim\tasks\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
